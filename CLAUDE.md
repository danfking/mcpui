...
A component library + streaming renderer + demo app that connects to any MCP server and renders navigable visual dashboards from tool call results. Schema-driven, no LLM required.
